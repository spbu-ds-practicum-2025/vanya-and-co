...
const file_file_proto_rawDesc = "" +
	...
	"\amessage\x18\x04 \x01(\tR\amessage2\xc2\x01\n" +
	"\vFileService\x12;\n" +
	...
	"\bDownload\x12\x17.filepb.DownloadRequest\x1a\x18.filepb.DownloadResponseBEZCgithub.com/spbu-ds-practicum-2025/vanya-and-co/services/file/filepbb\x06proto3"
...
var file_file_proto_depIdxs = []int32{
	...
	2, // 4: filepb.FileService.List:output_type -> filepb.ListFilesResponse
	4, // 5: filepb.FileService.Upload:output_type -> filepb.UploadResponse
	6, // 6: filepb.FileService.Download:output_type -> filepb.DownloadResponse
